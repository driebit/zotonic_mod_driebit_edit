    ...
    <nav class="ginger-edit__nav--footer">
        <div class="navbar-inner row">
            <div class="col-xs-12" id="save-buttons">
                {% ifnotequal id 1 %}
                    {% button class="btn--delete" disabled=(id.is_protected or not id.is_deletable) id="delete-button" text=_"Delete" action={dialog_delete_rsc id=id.id on_success={redirect back}} title=_"Delete this page." %}
                {% endifnotequal %}
